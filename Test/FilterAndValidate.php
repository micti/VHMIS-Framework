...
echo $a . " ->> alnum ->> ";  var_dump($validator->alnum($a));
echo '<br>'. "\n";
echo $a . " ->> alnum ->> ";  var_dump($validator->alnum($a, false, true));
echo '<br>'. "\n";
echo $a . " ->> alnum ->> ";  var_dump($validator->alnum($a, true, true));
echo '<br>'. "\n";
echo $a . " ->> alnum ->> ";  var_dump($validator->alnum($a, true, false));
echo '<br>'. "\n";

$a = 'sfffgfg fhgfjgfjdgfgfjkgf gfjgfkjgfjkgfjk 0405459565';
echo $a . " ->> alnum ->> ";  var_dump($validator->alnum($a, true));
echo '<br>'. "\n";

$a = 'cổng vàng djdsfk sd klfdsi';
echo $a . " ->> alpha ->> ";  var_dump($validator->alpha($a));
echo '<br>'. "\n";
echo $a . " ->> alpha ->> ";  var_dump($validator->alpha($a, false, true));
echo '<br>'. "\n";
echo $a . " ->> alpha ->> ";  var_dump($validator->alpha($a, true, true));
echo '<br>'. "\n";
echo $a . " ->> alpha ->> ";  var_dump($validator->alpha($a, true, false));
echo '<br>'. "\n";

$a = 'sfffgfg fhgfjgfjdgfgfjkgf';
echo $a . " ->> alpha ->> ";  var_dump($validator->alnum($a, true));
echo '<br>'. "\n";
