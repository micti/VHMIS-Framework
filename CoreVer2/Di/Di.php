...
class Di
{
    ...
    public function newInstance($class, $oParams)
    {
        ...
        if($info['constructor'] == null) $object = $reflect->newInstanceWithoutConstructor();
        else {
    ...
    {
        if(!isset($this->_classReflect[$class])) $this->_classReflect[$class] = new \ReflectionClass($class);
    ...
    {
        if(isset($this->_classInfo[$class])) return $this->_classInfo[$class];
