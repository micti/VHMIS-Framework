...
abstract class Vhmis_Model extends Zend_Db_Table_Abstract
{
    ...
    /**
     * Tự động điền thông tin cho giá trị trường của một row nếu trường đó đang
     * nhận giá trị rỗng
    ...
    /**
     * Chuyển một đối tượng row sang entity dạng mảng (cùng chức năng với
     * toArray)
     *
     * @return mảng dữ liệu của đối tượng
     */
    ...
    {
        // Đối với bảng chỉ có 1 primary key, có thể đưa vào chuỗi chứa nhiều
        // primary key, cách nhau bằng dấu phẩy
        if (is_string($keys)) {
            $keys = explode(',', $keys);
        }
