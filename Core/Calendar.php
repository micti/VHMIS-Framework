...
class Vhmis_Calendar
{
    ...
    public function datesOfMonth($month, $year, $fix = true)
    {
        ...
        //Tìm tất cả các ngày của tháng trước cùng tuần với ngày đầu tiên của tháng
        if($fix && $day != 1)
        {
        ...
        // Các ngày của tháng kế tiếp trùng với tuần của ngày cuối cùng của tháng hiện tại
        if($fix && $day != 1)
        {
